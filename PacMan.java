...
public class PacMan extends Frame implements Runnable {
	...
	int[] numY = new int[5];
	public PacMan() {
		img = Toolkit.getDefaultToolkit().getImage("D:/Again/Review/src/pacmanRemind/pacman.png");
		foodImg = Toolkit.getDefaultToolkit().getImage("D:/Again/Review/src/pacmanRemind/foodImg.png");
